...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { email: @visitor.email, name: @visitor.name, number: @visitor.number, org: @visitor.org, web: @visitor.web } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { email: @visitor.email, name: @visitor.name, number: @visitor.number, org: @visitor.org, web: @visitor.web } }
